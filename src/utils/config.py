...
DATA_COLLECTION_OUT_DIR = "data/interim"
LOG_DIR = "logs"
...
REDDIT_MENTIONS23_DIR = f"{DATA_COLLECTION_OUT_DIR}/reddit/subreddits23_mentions" # directory for ticker mentions <=2023
REDDIT_MENTIONS24_DIR = f"{DATA_COLLECTION_OUT_DIR}/reddit/subreddits24_mentions"

# Historical reddit data parameters
REDDIT_NUM_WORKERS = 8 # Number of workers for parallel processing
REDDIT_CHUNK_SIZE = 1024 * 1024  * 2 # (1024 * 1024) or 1 MB chunks 
